  ...
  for (let id in cartItems) {
    if (cartItems[id].quantity !== 0) {
      billComponents.push({
        ...
        pricing: cartItems[id].price,
      });
    }
  }

  return (
   (checkout? (<div className="payment-container">
        ...
        <table id="cart" className="table table-hover table-condensed">
...

          {
            billComponents.map((component, index) => {
              return (<Bill key={index} props={component} onUpdateSubtotal={handleSubtotalChange} onDeleteProduct={handleProductDelete}/>)
            })
          }
          ...
          <tfoot>
            <tr>
              <td>
                <Link to='/' href="#" className="btn btn-warning">
