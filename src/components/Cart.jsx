   ...
   useEffect(() => {
    ...
    useEffect(() => {
        ...
        for (let product of items) {
            const subtotal = subtotalMap[product.productId] * product.productPrice;
            newTotal += subtotal;
        }
        setTotal(newTotal);
    }, [subtotalMap, items]);
                        ...
                        <table id="cart" className="table table-hover table-condensed">
                                    ...
                                    <tr key={product.productId}>
                                        <td data-th="Product">
                                            <div className="row">
                                                ...
                                                <div className="col-sm-10">
                                                    <h4 className="nomargin">{product.productName}</h4>
                                        ...
                                        <td data-th="Quantity">
                                            <input
                                                ...
                                                value={subtotalMap[product.productId] || 1}
                                                onChange={(e) => handleSubtotalChange(product.productId, e.target.value)}
                                            />
                                        </td>
                            ...
                            <tfoot>
                                <tr>
                                    ...
                                    <td>
                                        <button className="btn btn-success btn-block" onClick={() => { setCheckout(!checkout) }}>
